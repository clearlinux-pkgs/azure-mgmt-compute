...
Source0  : https://files.pythonhosted.org/packages/fa/c8/4e188e19742ebef216d9edda6d81f468d7ebd223da397f44358305ae8404/azure-mgmt-compute-18.0.0.zip
Summary  : Microsoft Azure Compute Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-compute-python = %{version}-%{release}
Requires: azure-mgmt-compute-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-compute package.
Group: Default
Requires: azure-mgmt-compute-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-compute package.


%package python3
Summary: python3 components for the azure-mgmt-compute package.
Group: Default
...
%description python3
python3 components for the azure-mgmt-compute package.


%prep
%setup -q -n azure-mgmt-compute-18.0.0
cd %{_builddir}/azure-mgmt-compute-18.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608045883
